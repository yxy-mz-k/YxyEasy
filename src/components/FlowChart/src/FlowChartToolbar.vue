...
const toolbarItemList = ref<ToolbarConfig[]>([
  ...
  {
    type: ToolbarTypeEnum.SYNC_DATA,
    icon: "ant-design:file-sync-outlined",
    tooltip: "同步产品数据",
  },
  {
    type: ToolbarTypeEnum.DOWNLAD,
    icon: "ant-design:download-outlined",
    tooltip: "导出数据",
  },
  /*   {
             type: ToolbarTypeEnum.UPLOAD,
             icon: 'ant-design:upload-outlined',
             tooltip: '导入数据',
           },*/
  {
    type: ToolbarTypeEnum.PASTE,
...
const onControl = (item) => {
  ...
  switch (item.type) {
    ...
    case ToolbarTypeEnum.SAVE_DATA:
      emit("save-data");
      break;
    case ToolbarTypeEnum.SYNC_DATA:
      emit("sync-data");
      break;
    case ToolbarTypeEnum.DOWNLAD:
      emit("download");
      break;
    case ToolbarTypeEnum.UPLOAD:
      emit("upload");
      break;
    case ToolbarTypeEnum.PASTE:
      emit("paste");
      break;
  }
};
